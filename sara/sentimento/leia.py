...
NEGATE = [t.strip() for t in open('sara/sentimento/lexicons/negate.txt')]

# Booster/dampener 'intensifiers' or 'degree adverbs' (Portuguese)
boosters = []
for l in open('sara/sentimento/lexicons/booster.txt'):
    parts = l.strip().split(' ')
...
class SentimentIntensityAnalyzer(object):
    ...
    def __init__(self, lexicon_file="sara/sentimento/lexicons/vader_lexicon_ptbr.txt", emoji_lexicon="sara/sentimento/lexicons/emoji_utf8_lexicon_ptbr.txt"):
